...
| 版本 | 模块                                                         | 描述 |
| ---- | ------------------------------------------------------------ | ---- |
| 0415 | 【数据查询服务-调优版本】：<br />1.具备在线数据查询能力: 通过自然语言实现大小数据量, 异构对象的查询.<br />2.通过超级分析智能体整合数据服务,知识服务,跑通最小化流程. |      |
| 0430 | 【开源-数据查询服务-V1】：别的agent可通过MCP，api集成dataCloud的数据查询组件。 |      |
