...
```
POST /api/v1/ontologyBases/{ownerType}/{baseId}/scenes/{sceneId}/graph/path
```
...
curl -X POST \
  ...
  "https://$HOSTNAME/api/v1/ontologyBases/personal/bio_platform/scenes/2064947287571644418/graph/path" \
  -d '{
    "matchBy": "name",
    "startNode": "北京市石景山区",
    "endNode": "",
