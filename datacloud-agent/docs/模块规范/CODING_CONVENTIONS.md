# 编码规范 — datacloud-agent 专项

> **extends**: [`/docs/项目规范/CODING_CONVENTIONS.md`](../../../docs/项目规范/CODING_CONVENTIONS.md)（Monorepo 根规范，优先级更高）
>
> **适用范围**：`datacloud-agent` 子项目，`src/datacloud-agent/` 下所有 Python 源码
>
> **说明**：本文档**仅包含 datacloud-agent 特有内容**，通用编码规范见根文档。
