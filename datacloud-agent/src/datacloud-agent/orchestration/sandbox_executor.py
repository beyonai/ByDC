...
def _register_dispatchers() -> None:
    ...
    try:
        from datacloud_agent.tools.data import data_query  # noqa: PLC0415
        from datacloud_agent.tools.knowledge import search_knowledge  # noqa: PLC0415
        from datacloud_agent.tools.report import render_report  # noqa: PLC0415
        from datacloud_agent.tools.sandbox import sbx_read_file, sbx_run_code, sbx_write_file  # noqa: PLC0415
        from datacloud_agent.tools.skill import build_skill  # noqa: PLC0415
        from datacloud_agent.memory.tools import recall_memory  # noqa: PLC0415
