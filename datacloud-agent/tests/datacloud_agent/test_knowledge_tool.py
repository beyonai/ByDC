...
注意：在 tests/datacloud_agent 下，pytest 可能将 tests 置于 path 首位，
导致 datacloud_agent 解析为测试包。若导入失败则跳过。
"""
...
pytest.importorskip("datacloud_agent.tools.knowledge")

import datacloud_agent.tools.knowledge as knowledge_module
