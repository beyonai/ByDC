...
所有子项目统一遵守以下规范文档，**以根目录文档为最高优先级**：

| 规范文档 | 说明 | 优先级 |
|----------|------|--------|
| [`docs/CODING_CONVENTIONS.md`](docs/CODING_CONVENTIONS.md) | Python 编码规范（全项目通用） | **根级 · 最高** |
| [`docs/TESTING_CONVENTIONS.md`](docs/TESTING_CONVENTIONS.md) | 测试规范，覆盖率 ≥ 90%（全项目通用）| **根级 · 最高** |
| `<subproject>/docs/CODING_CONVENTIONS.md` | 子项目专项编码规范（扩展根规范）| 子项目级 |
| `<subproject>/tests/CONVENTIONS.md` | 子项目测试目录结构（扩展根规范）| 子项目级 |

> **规范继承原则**：子项目规范 = 根规范 + 子项目专项扩展。根规范与子项目规范冲突时，根规范优先。
