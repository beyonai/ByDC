...
可选参数：`--index 0/1/2` 指定某一篇，不传则依次输出三篇。

对每篇纪要重复第 2 步的 baiying_call 写入操作，让后续融合查询有更多内容可展示。
...
> 这就是**结构化+非结构化融合** — 文档整篇录入，标签自动提取，一次查询同时返回结构化字段和全文内容。
>
> 6 个核心能力都演示完了！有没有哪个你想深入了解，或者想在你自己的业务场景里试试？
