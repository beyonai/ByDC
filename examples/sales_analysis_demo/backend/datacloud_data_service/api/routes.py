...
def create_app(
    *,
    ...
    sdk_logger = logging.getLogger("datacloud_data")
    ...
    async def _lifespan(app: FastAPI) -> AsyncIterator[None]:
        ...
        if settings.llm_api_key:
            try:
                from datacloud_data.plan.query_plan_generator import LangGraphPlanGenerator
    ...
    if graphql_registry.exists():
        ...
        from datacloud_data.graphql.server import get_graphql_router
