...
def handle_update_terms_name_command(  # noqa: PLR0911
    *,
    ...
    Returns:
        (handled, payload)
        - handled=False: command not matched.
        - handled=True and payload=None: silent mode or no user-facing payload.
        - handled=True and payload=dict: response envelope for 6001 output.
    """
