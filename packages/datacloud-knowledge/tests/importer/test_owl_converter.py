...
class TestParseJsonField:
    ...
    def test_parse_whitespace_string_returns_default(self):
        """测试空白字符串返回默认值。"""
        result = parse_json_field("   ", default="default")
        assert result == "default"
    ...
    def test_parse_list_input_returns_list(self):
        """测试列表输入直接返回。"""
        input_list = ["a", "b"]
        result = parse_json_field(input_list, default=[])
        assert result is input_list

    def test_parse_dict_input_returns_dict(self):
        """测试字典输入直接返回。"""
...
class TestMapCardinality:
    ...
    def test_map_many_to_many(self):
        """测试 MANY_TO_MANY 映射。"""
...
class TestConvertDomain:
    ...
    def test_convert_domain_basic(self):
        """测试基本字段转换。"""
        owl_entity = {
            "domain_code": "sales",
            "domain_name": "销售",
    ...
    def test_convert_domain_missing_fields(self):
        """测试缺失字段返回 None。"""
    ...
    def test_convert_domain_empty_entity(self):
        """测试空实体。"""
...
class TestConvertTermType:
    ...
    def test_convert_term_type_basic(self):
        """测试基本字段转换。"""
        owl_entity = {
    ...
    def test_convert_term_type_extract_domain_from_path(self):
    ...
    def test_convert_term_type_typo_aliases(self):
        """测试 typo 别名映射。"""
        owl_entity = {
    ...
    def test_convert_term_type_missing_path_returns_none(self):
...
class TestConvertTerm:
    ...
    def test_convert_term_basic(self):
        """测试基本字段转换。"""
        owl_entity = {
            "term_code": "po_users",
            "term_name": "人员",
    ...
    def test_convert_term_with_synonyms(self):
        """测试同义词解析。"""
        owl_entity = {
            "term_name": "人员",
            "synonyms": '["员工", "用户"]',
    ...
    def test_convert_term_synonyms_exclude_self(self):
        """测试同义词排除自身。"""
        owl_entity = {
            "term_name": "人员",
            "synonyms": '["人员", "员工"]',
    ...
    def test_convert_term_normalize_synonyms(self):
        """测试同义词清洗（去除空白）。"""
        owl_entity = {
            "term_name": "人员",
            "synonyms": '["  员工  ", "用户", ""]',
    ...
    def test_convert_term_malformed_synonyms_returns_empty(self):
    ...
    def test_convert_term_non_list_synonyms_returns_empty(self):
    ...
    def test_convert_term_missing_domain_code(self):
...
class TestConvertRelation:
    ...
    def test_convert_relation_basic(self):
        """测试基本字段转换。"""
        owl_entity = {
            "source_library": "HR",
            "source_type": "术语类型",
    ...
    def test_convert_relation_with_cardinality_mapping(self):
    ...
    def test_convert_relation_malformed_joinkeys_returns_empty(self):
    ...
    def test_convert_relation_non_list_joinkeys_returns_empty(self):
    ...
    def test_convert_relation_missing_optional_fields(self):
        """测试缺失可选字段。"""
        owl_entity = {
            "source_library": "HR",
            "source_type": "术语类型",
    ...
    def test_convert_relation_malformed_ext_field(self):
...
class TestExtractKnowledgeRecords:
    ...
    def test_extract_knowledge_records_basic(self, monkeypatch: pytest.MonkeyPatch):
        """测试知识记录提取与字段映射。"""
    ...
    def test_extract_knowledge_records_accepts_list_input(self, monkeypatch: pytest.MonkeyPatch):
        """测试已解析列表输入。"""
        monkeypatch.setattr(
            "datacloud_knowledge.knowledge_build.importer.owl_converter._next_snowflake_id",
            lambda: "kid-1",
    ...
    def test_extract_knowledge_records_malformed_json_returns_empty(self):
    ...
    def test_extract_knowledge_records_non_list_returns_empty(self):
        """测试非列表 JSON 返回空列表。"""
    ...
    def test_extract_knowledge_records_skip_non_dict_items(self, monkeypatch: pytest.MonkeyPatch):
        """测试跳过非对象知识项。"""
        monkeypatch.setattr(
            "datacloud_knowledge.knowledge_build.importer.owl_converter._next_snowflake_id",
            lambda: "kid-1",
...
class TestRelationTypeToCardinalityConstant:
    ...
    def test_constant_contains_all_types(self):
        """测试常量包含所有关系类型。"""
