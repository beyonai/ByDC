...
ALTER TABLE whale_datacloud.term_library DROP CONSTRAINT IF EXISTS chk_term_library_library_code;
...
ALTER TABLE whale_datacloud.term DROP CONSTRAINT IF EXISTS uq_term_term_code;
