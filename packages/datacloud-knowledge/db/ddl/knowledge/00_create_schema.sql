...
DROP TABLE IF EXISTS term_domain CASCADE;
-- 以下三表为旧 domain 设计，保留 DROP 以清理存量数据
DROP TABLE IF EXISTS domain_term_type CASCADE;
DROP TABLE IF EXISTS domain_library CASCADE;
