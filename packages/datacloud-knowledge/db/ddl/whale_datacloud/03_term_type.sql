...
COMMENT ON TABLE term_type IS '术语类型表：定义术语的分类编码体系，扁平化设计';
COMMENT ON COLUMN term_type.type_id       IS '自增主键';
COMMENT ON COLUMN term_type.type_code     IS '术语类型编码，唯一，如 OBJ/VIEW/ACTION/FUNC/PARAM/PROP/EMPLOYEE';
COMMENT ON COLUMN term_type.type_name     IS '术语类型名称';
COMMENT ON COLUMN term_type.type_desc     IS '术语类型描述';
COMMENT ON COLUMN term_type.type_category IS '大分类：1=列表术语, 2=字典术语, 3=本体术语, 4=文档名称术语';
