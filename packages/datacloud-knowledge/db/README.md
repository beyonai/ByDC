...
├── ddl/whale_datacloud/        ← 建表 DDL，按 00~99 顺序执行
...
│   └── 01_term_type_builtin.sql  ← 内置术语类型（EMPLOYEE / GENERAL / ONTOLOGY_* 共 8 条）
└── scripts/
...
# export DB_SCHEMA=whale_datacloud  # 可选，默认 whale_datacloud
```
