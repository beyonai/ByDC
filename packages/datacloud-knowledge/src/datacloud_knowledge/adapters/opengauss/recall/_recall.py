...
from ._models import RecallRequest, ScopeRecallLayer
from ._recall_common import (
    KTYPE_CATEGORY_MAP,
    _load_type_codes_by_category,
    _shape_candidates,
)
from .typed_recall import typed_multi_recall_with_session
...
def _vector_only_recall(
    ...
    *,
    ...
    from ._paths import _batch_vector  # deferred; see above
