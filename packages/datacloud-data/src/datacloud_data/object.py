...
class Object:
    ...
    async def query(self, question: str, include_plan: bool = True) -> dict[str, object]:
        ...
        from datacloud_data.plan.data_permission_rewriter import DataPermissionRewriter
        from datacloud_data.executor.executor import Executor
        ...
        from datacloud_data.exceptions import CannotAnswerError, PlanValidationError
        ...
        observer = None
        if config.event_bus:
            from datacloud_data.events.query_observer import QueryObserver
        ...
        try:
            ...
            try:
                ...
                logging.getLogger("datacloud_data").info(
