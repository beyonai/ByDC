...
4. 若 DB 字段带 termType / termLabels / termHint，可直接在 SQL WHERE 或 API params 中填写用户问题里的名称或文本值，不要额外查 ID。
5. API step 的 params 只能填写 action.inputParams 中声明的 paramCode；enum 值必须来自 termLabels。
