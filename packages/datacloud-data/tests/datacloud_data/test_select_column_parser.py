...
def test_extract_columns_custom() -> None:
    ...
    assert extract_select_columns(sql) == ["id", "customerName", "belongDepart", "type", "buildContent", "iwhaleCbmEmpNo", "iwhaleCbmName", "iwhaleCbmOrgId", "belongIndustry", "itInvestmentScale", "dataYear", "softwareSaleScale", "nextYearPredictScale", "contractScale", "process", "mainBusiness", "submitPerson", "submitOrganization", "businessOpportunityProcess", "customerTaxId", "instanceId"]
