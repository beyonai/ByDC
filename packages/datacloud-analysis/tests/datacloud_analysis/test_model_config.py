...
from datacloud_analysis.core.model_config import create_model, get_default_model_config
...
class TestCreateModel:
    ...
    def test_uses_api_key_from_config(self):
        ...
        with patch("datacloud_analysis.core.model_config.ChatOpenAI") as mock_model:
