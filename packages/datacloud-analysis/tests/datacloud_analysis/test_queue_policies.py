...
async def test_summarize_async_with_mocked_agent(queue_manager):
    ...
    with (
        patch("datacloud_analysis.queue.manager.init_chat_model") as mock_init_model,
        patch("datacloud_analysis.queue.manager.create_deep_agent") as mock_create_agent,
    ):
        # Setup mock agent
...
async def test_summarize_async_with_exception(queue_manager):
    ...
    with patch("datacloud_analysis.queue.manager.init_chat_model") as mock_init_model:
