"""Unit tests for datacloud_analysis.session.pg_opengauss.
...
from datacloud_analysis.session.pg_opengauss import (
    OpenGaussSaver,
    SyncPGCheckpointer,
...
class TestGetCheckpointer:
    ...
    async def test_yields_sync_pg_checkpointer_on_success(self, monkeypatch):
        ...
        with (
            ...
            patch(
                "datacloud_analysis.session.pg_opengauss.make_opengauss_saver",
